...
| Страница | URL |
|----------|-----|
| Круг + тональность (номера ступеней на выбранном секторе) | **https://zagoguleolog.github.io/app/circle-scales.html** |
